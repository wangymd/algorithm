package com.algorithm.basic.datastructure.stack.apply;

import com.algorithm.basic.datastructure.stack.MyLinkedStack;
import com.algorithm.basic.datastructure.stack.MySeqStack;
import com.algorithm.basic.datastructure.stack.Stack;
...
public class CalculateExpressionTest {
	 ...
	 * @return
	 */
	public static String toPostfix(String expstr) throws Exception{
		// 创建栈,用于存储运算符
		Stack<String> stack = new MySeqStack<>(expstr.length());
	 ...
	 * @return
	 */
	public static int calculatePostfixValue(String postfix) throws Exception{
		// 栈用于存储操作数,协助运算
